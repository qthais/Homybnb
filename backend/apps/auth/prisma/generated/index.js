...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\WorkSpace\\RentalApp\\backend\\apps\\auth\\prisma\\generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\WorkSpace\\RentalApp\\backend\\apps\\auth\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/auth/prisma/generated",
    "auth/prisma/generated",
  ]
...
path.join(process.cwd(), "apps/auth/prisma/generated/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/auth/prisma/generated/schema.prisma")
